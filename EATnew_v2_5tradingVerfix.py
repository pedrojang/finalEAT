        ...
        if nownow()%15 == 0 :
            ...
            if not(actiontime == nownow()):
                ...
                if MTGGSM(CorrectTime - 5):
                    ...
                    title = 'P-SELL'
                    mail(text,title)
                if LP == True and STARTtime + (datetime(1,1,1,9,30) - datetime(1,1,1,9)) > datetime.now() and STARTtime + (datetime(1,1,1,9,15) - datetime(1,1,1,9)) <= datetime.now() and ls_oclo[CorrectTime] < MLL :
                    LP = False 
                    sellbit(PN)
                    sellnum = getcurrent()
                    time.sleep(1)
                    ...
                    title = 'BD-S'
                    mail(text,title)
                if SP == True and STARTtime + (datetime(1,1,1,9,30) - datetime(1,1,1,9)) > datetime.now() and STARTtime + (datetime(1,1,1,9,15) - datetime(1,1,1,9)) <= datetime.now() and ls_ochi[CorrectTime] > MLS :
                    SP = False
                    buybit(PN)
                    buynum = getcurrent()
                    time.sleep(1)
